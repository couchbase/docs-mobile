...
:component-title-mob: Couchbase Mobile
...
:xref-url-cb-blog: {url-cb-blog}[Couchbase Mobile blog]
:xref-url-cb-forum: {url-cb-forum}[Couchbase forum]
:xref-url-cb-forum-mobile: {url-cb-forum-mobile}[Couchbase Mobile Forum]
